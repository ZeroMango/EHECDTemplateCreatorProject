...
function 操作模块(){
    ...
    function initModule(){
        try{
            ...
            /*更改，也可以沿用这个名字以保证一致性
            */
            initDataGrid$4542c4ceb4734064ac8b9dea6bc31a97();
        }catch (e){
            //这里请自行处理异常
        }
    }
    ...
    /* 初始化datagrid
    */
    function initDataGrid$4542c4ceb4734064ac8b9dea6bc31a97(){
        try {
...
,{                    field: "字段名",halign: "left" ,align: "left", title: "columnName", width: 100,}
            ...
            initDatagridBtn$31c29bcf7e364893b8fad25c724d3091();
        } catch (e) {
        }
    }
    ...
    /* 初始化datagrid的操作按钮
    */
    function initDatagridBtn$31c29bcf7e364893b8fad25c724d3091(){
        try{
